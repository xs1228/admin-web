	...
	<div class="login-container flx-center">
		<div class="login-box">
			<div class="login-left">
				<img src="@/assets/images/login/login_left.svg" alt="login" />
			</div>
			<div class="login-form">
				<div class="login-logo">
					<img class="login-icon" src="@/assets/images/login/logo.svg" alt="" />
					<p class="logo-text">My-Admin</p>
				</div>
				<LoginForm ref="loginRef" :age="'20'" :obj="obj"></LoginForm>
			</div>
		</div>
	</div>
</template>
